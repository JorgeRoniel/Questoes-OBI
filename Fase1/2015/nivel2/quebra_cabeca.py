...
N = int(input("Numero de peças: ")) #pegamos do usuario o numero de peças a ser usado
...
for i in range(N):
    I = input('Insira a peça: ').split() #Aqui recebemos as peças inseridas pelo usuario, a função split divide a entrada e guarda no I como uma lista
